...
### 2.1. Availability 관련 타입 정의 (domain/member/types)
...
### 2.2. Availability API 함수 구현 (getMyAvailability, updateMyAvailability)
...
### 2.3. Availability TanStack Query 훅 구현 (useMyAvailability, useUpdateMyAvailability)
...
### 2.5. ScheduleManagerModal 컴포넌트 구현 (2단계 모달)
...
### 2.6. MeContent에 WeeklyTimetable 섹션 통합
